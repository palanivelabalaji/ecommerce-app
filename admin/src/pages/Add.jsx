  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write your description' required />
      </div>
      ...
      <div className='flex flex-col sm:flex-row w-full sm:gap-8'>
        ...
        <div>
          <p className='mb-2'>Product Pricce</p>
